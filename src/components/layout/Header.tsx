...
export function Header() {
  ...
  const navLinks = [
    ...
    { href: "/my-flights", label: "My Flights" },
    { href: "/request-ticket", label: "Name Your Price" },
  ...
  return (
    <header className="fixed left-0 right-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/50" style={{ top: 'var(--promo-banner-height, 0px)' }}>
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
          {/* Logo */}
          <Link to="/" className="flex items-center gap-2 group">
            <img src={logo} alt="Your Travel Agent" className="w-12 h-12 object-contain group-hover:scale-105 transition-transform duration-300" />
