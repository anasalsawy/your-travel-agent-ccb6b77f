...
const capabilities = [
  ...
  },
  {
    ...
    description: "Finds the best deals and routes for your travel needs in real-time",
    color: "text-blue-500",
  ...
  },
  {
    ...
    description: "Builds detailed ticket requests so we can find you the best price",
  ...
  },
  {
    icon: Bell,
    title: "Follows Up",
    description: "Tracks your requests and keeps you updated on progress",
