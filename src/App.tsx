...
const MobileAgentRoundtable = lazy(() => import("./pages/mobile-admin/MobileAgentRoundtable"));
const MobileBookingAgent = lazy(() => import("./pages/mobile-admin/MobileBookingAgent"));
      ...
      <BrowserRouter>
        <Suspense>
          <Routes>
            ...
            <Route path="/m/roundtable" element={<MobileAgentRoundtable />} />
            <Route path="/m/booking-agent" element={<MobileBookingAgent />} />
